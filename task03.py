...
def draw_graph(x, y, x_label, y_label, title, filename):
    """
    Draw graph and save it to specified file
    """
    fig, ax = plt.subplots()
...
for algo in algorithms:
    for i, n in enumerate(pattern_sizes):
        ...
        algo_result_1[algo].append(timeit.timeit('algorithms[algo](article1,pattern1)', 
                                                 number=REPEATS_PER_TEST, globals=globals()))
        algo_result_2[algo].append(timeit.timeit('algorithms[algo](article2,pattern2)', 
                                                 number=REPEATS_PER_TEST, globals=globals()))
        algo_result_1_random[algo].append(timeit.timeit('algorithms[algo](article1,random_string_1[i])',
                                                        number=REPEATS_PER_TEST, globals=globals()))
        algo_result_2_random[algo].append(timeit.timeit('algorithms[algo](article2,random_string_1[i])',
                                                        number=REPEATS_PER_TEST, globals=globals()))
        algo_result_1_ab[algo].append(timeit.timeit('algorithms[algo](article1,random_string_2[i])',
                                                    number=REPEATS_PER_TEST, globals=globals()))
        algo_result_2_ab[algo].append(timeit.timeit('algorithms[algo](article2,random_string_2[i])',
                                                    number=REPEATS_PER_TEST, globals=globals()))
